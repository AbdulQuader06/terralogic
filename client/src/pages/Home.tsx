...
import { Download, CheckCircle, ChevronDown, Search, Loader2, X, Camera, Sun, Moon, BookOpen } from "lucide-react";
      ...
      <header className="h-12 border-b border-border bg-card flex items-center px-4 justify-between z-10 shrink-0">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            variant="outline"
            onClick={() => {
              handleLocationSelect(17.385, 78.4867, "Hyderabad, India");
          ...
          <button
            ...
            style={{
              ...
              borderColor: isDark ? "hsl(220, 30%, 25%)" : "hsl(25, 60%, 80%)",
            }}
