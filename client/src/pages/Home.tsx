...
export default function Home() {
  ...
  const [leftTab, setLeftTab] = useState<"layers" | "chat">("layers");
  ...
  const handleSearch = async () => {
    if (!searchQuery.trim() || !arcgisApiKey) return;
    setIsSearching(true);
    try {
      const response = await fetch(
        `https://geocode-api.arcgis.com/arcgis/rest/services/World/GeocodeServer/findAddressCandidates?f=json&singleLine=${encodeURIComponent(searchQuery)}&maxLocations=5&token=${arcgisApiKey}`
      );
  ...
  return (
    <div className="flex h-screen w-full bg-background overflow-hidden flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        <div className="w-[280px] min-w-[240px] border-r border-border bg-card flex flex-col shrink-0">
          ...
          <div className="px-4 pb-2 flex gap-1">
            ...
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="m12 2 10 6.5v7L12 22 2 15.5v-7L12 2z"/><path d="M12 22V15.5"/><path d="m22 8.5-10 7-10-7"/></svg>
              Data Layers
            </button>
            <button
            ...
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="m2 14 6-6 6 6"/></svg>
              AI Assistant
            </button>
          </div>
          ...
          <div className="flex-1 overflow-hidden">
            {leftTab === "layers" ? (
              ...
              <ChatPanel location={selectedLocation} />
            )}
          </div>

          <div className="px-4 py-2.5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground">
            <span>Active Layers <strong className="text-foreground">{activeLayers.length}/10</strong></span>
